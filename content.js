...
function applyToggleButtons2() {
  ...
  furtherInfoMessages.forEach((message) => {
    if (
      message.innerText.includes("Further Information Log") &&
      !message.querySelector(".toggle-button")
    ) {
      ...
      if (startIndex !== -1) {
        ...
        const updatedVisiblePart = visiblePart.replace(
          "Further Information Log",
